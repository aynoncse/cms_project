...
<body>
    ...
    <div class="container">
      <div class="row gap-y align-items-center">
        ...
        <div class="col-6 col-lg-3">
          <a href="{{ url('/') }}"><img src="{{asset('public/img/logo-dark.png')}}" alt="logo"></a>
        </div>
  ...
  <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5d90f6596111b18f"></script>
</body>
</html>
